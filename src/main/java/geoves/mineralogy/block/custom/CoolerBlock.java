...
public class CoolerBlock extends BlockWithEntity implements BlockEntityProvider {
    public static final EnumProperty<Direction> FACING = HorizontalFacingBlock.FACING;
    public static final BooleanProperty ACTIVE = BooleanProperty.of("active");
    public static final MapCodec<CoolerBlock> CODEC = CoolerBlock.createCodec(CoolerBlock::new);
    ...
    protected ActionResult onUseWithItem(ItemStack stack, BlockState state, World world, BlockPos pos,
        ...
        if (!world.isClient) {
            NamedScreenHandlerFactory screenHandlerFactory = ((CoolerBlockEntity) world.getBlockEntity(pos));
        ...
        if (world instanceof ServerWorld){
            if(state.getBlock() != newState.getBlock()) {
                ...
                if(blockEntity instanceof CoolerBlockEntity) {
                    ItemScatterer.spawn(world, pos, ((CoolerBlockEntity) blockEntity));
    ...
    public <T extends BlockEntity> BlockEntityTicker<T> getTicker(World world, BlockState state, BlockEntityType<T> type) {
        ...
        return validateTicker(type, ModBlockEntities.COOLER_BE,
